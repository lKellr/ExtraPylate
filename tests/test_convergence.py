...
class TestConvergence:
    ...
    #     ]
    #     + [
    #         (EulerExtrapolationMass, k, k + 1, {"mass_matrix": np.eye(2)})
    #         for k in [1, 3, 5]
    #     ]
    ...
    #     ]
    #     + [
    #         (ModMidpointExtrapolationMass, k, k + 1, {"mass_matrix": np.eye(2)})
    #         for k in [1, 3, 5]
    #     ]
    #     + [
    #         (
    #             ModMidpointExtrapolationMass,
    #             k,
    #             k + 1,
    #             {"mass_matrix": np.eye(2), "use_smoothing": True},
    #         )
    #         for k in [1, 3, 5]
    #     ]
    #     + [(ModMidpointExtrapolationRational, k, k + 1, {}) for k in [1, 3, 5]]
    #     + [(LimplicitEulerExtrapolation, k, k + 1, {"num_odes": 2}) for k in [1, 3, 5]]
    #     + [
    #         (LimplicitMidpointExtrapolation, k, k + 1, {"num_odes": 2})
    #         for k in [1, 3, 5]
    #     ]
    #     + [
    #         (
    #             LimplicitMidpointExtrapolation,
    #             k,
    #             k + 1,
    #             {"num_odes": 2, "use_smoothing": True},
    #         )
    #         for k in [1, 3, 5]
    #     ],
    # )
